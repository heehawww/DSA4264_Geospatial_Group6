...
- `school_group_interaction_results.csv`
- `school_group_interaction_coefficients.csv`
- `rdd_summary.json`
...
- RDD endpoints: `school_specific_rdd_results.csv`, `school_specific_rdd_coefficients.csv`, `school_specific_rdd_skipped.csv`, `school_group_interaction_results.csv`, `school_group_interaction_coefficients.csv`, `rdd_summary.json`
